...
public class SpecificationServiceImpl implements SpecificationService {
	...
	public void update(Specification specification){
		...
		for(TbSpecificationOption specificationOption:specification.getSpecificationOptionList()){ 
				...
				specificationOptionMapper.insert(specificationOption);//添加新增的
	...
	public PageResult findPage(TbSpecification specification, int pageNum, int pageSize) {
		 ...
		 * 
		 * 增加规格选项和规格名称
		 * @see com.pinyougou.sellergoods.service.SpecificationService#add(com.pinyougou.pojogroup.Specification)
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see com.pinyougou.sellergoods.service.SpecificationService#selectOptionList()
		 */
		@Override

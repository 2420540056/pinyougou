...
public class GoodsServiceImpl implements GoodsService {
	...
	@Autowired
	private TbGoodsDescMapper goodsDescService;
	...
	public void update(Goods goods) {
		...
		goodsDescService.updateByPrimaryKey(goods.getGoodsDesc());//保存商品扩展表
		//删除原有的 sku 列表数据 
	...
	public Goods findOne(Long id) {
		...
		TbGoodsDesc goodsDesc = goodsDescService.selectByPrimaryKey(id);
	...
	public PageResult findPage(TbGoods goods, int pageNum, int pageSize) {
		...
		if (goods != null) {
			if (goods.getSellerId() != null && goods.getSellerId().length() > 0) {
				...
				/*andSellerIdLike("%" + goods.getSellerId() + "%");*/
			}
	...
	*/
	...
	/*
	 * (non-Javadoc) 保存spu和sku
	 * 
	 * @see
	 * com.pinyougou.sellergoods.service.GoodsService#add(com.pinyougou.pojo.Goods)
	 */
	@Override
	public void add(Goods goods) {
		...
		System.out.println(goods.getGoodsDesc().getIntroduction()+"AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
		
		goodsDescService.insert(goods.getGoodsDesc());
